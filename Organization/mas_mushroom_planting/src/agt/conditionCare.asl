...
+shck1 <- initWeather(18,90); .println("temperature set to 18 and humidity set to 90% ").
+shck2 <- initWeather(17,90); .println("temperature set to 17 and humidity keep 90% ").
+shck3 <- initWeather(16,90); .println("temperature set to 16 and humidity keep 90% ").

+mdrt <- initWeather(19,85); .println("temperature set to 19 and humidity set to 85% ").  
/*
